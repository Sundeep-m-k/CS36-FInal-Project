...
def get_args_parser():
    ...
    parser.add_argument('--load_from', default='', help='load from pretrained models')
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--eval', action='store_true')
    parser.add_argument('--num_workers', default=2, type=int)

    # add params for point DETR
    ...
    parser.add_argument('--save_csv', default=None, type=str, help="val or trainPoint")
    ...
    parser.add_argument('--val_data', default='val', type=str, help="path to save result")
...
def main(args):
    ...
    if args.distributed:
        ...
        if not args.train_with_unlabel_imgs:
            ...
            print('='*100)
            sampler_train = build_mySampler(dataset_train, args.batch_size, args.partial, args)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('DETR with ViT Backbone - training and evaluation script', parents=[get_args_parser()])
